...
incbin "baserom.gbc", $59B4E, $1558
include "data/gate_info.asm"
incbin "baserom.gbc", $5B1A6, $E5A
...
incbin "baserom.gbc", $6C000, $126
include "data/text2.asm"
incbin "baserom.gbc", $6F57D, $A83
...
incbin "baserom.gbc", $7C000, $106
include "data/text3.asm"
incbin "baserom.gbc", $7F9FD, $603
...
incbin "baserom.gbc", $88000, $19E
include "data/text5.asm"
incbin "baserom.gbc", $8A90D, $16F2
...
incbin "baserom.gbc", $10C000, $193
include "data/text8.asm"
incbin "baserom.gbc", $10F72E, $8D2

section "Bank 68", ROMX
incbin "baserom.gbc", $110000, $157
include "data/text9.asm"
...
incbin "baserom.gbc", $118000, $180
include "data/text11.asm"
incbin "baserom.gbc", $11BDE0, $120

section "Bank 71", ROMX
incbin "baserom.gbc", $11C000, $C1
include "data/text12.asm"
incbin "baserom.gbc", $11DB73, $248D

section "Bank 72", ROMX
incbin "baserom.gbc", $120000, $16B
include "data/text13.asm"
...
incbin "baserom.gbc", $128000, $293
include "data/text15.asm"
incbin "baserom.gbc", $12AC25, $13DB

section "Bank 75", ROMX
incbin "baserom.gbc", $12C000, $D1
include "data/text16.asm"
incbin "baserom.gbc", $12E46E, $1B92
...
incbin "baserom.gbc", $138000, $143
include "data/text19.asm"
incbin "baserom.gbc", $13BA0C, $5F4
